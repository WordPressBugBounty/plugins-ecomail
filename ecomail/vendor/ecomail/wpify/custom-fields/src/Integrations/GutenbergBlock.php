 ...
 */
namespace EcomailDeps\Wpify\CustomFields\Integrations;
...
class GutenbergBlock extends BaseIntegration
{
    ...
    {
        if (defined('EcomailDeps\REST_REQUEST') && REST_REQUEST && filter_input(\INPUT_GET, 'context') !== 'edit' || null === $this->render_callback) {
            return $content;
        }

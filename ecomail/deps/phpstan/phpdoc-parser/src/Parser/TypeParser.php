...
class TypeParser
{
    ...
    private function parseAtomic(TokenIterator $tokens) : Ast\Type\TypeNode
    {
        ...
        $exception = new \EcomailDeps\PHPStan\PhpDocParser\Parser\ParserException($tokens->currentTokenValue(), $tokens->currentTokenType(), $tokens->currentTokenOffset(), Lexer::TOKEN_IDENTIFIER);

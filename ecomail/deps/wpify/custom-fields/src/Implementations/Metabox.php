...
final class Metabox extends AbstractPostImplementation
{
    ...
    public function __construct(array $args, CustomFields $wcf)
    {
        ...
        $args = wp_parse_args($args, array('id' => null, 'title' => null, 'screen' => null, 'context' => 'advanced', 'priority' => 'default', 'callback_args' => null, 'items' => array(), 'post_types' => array(), 'post_id' => null, 'init_priority' => 10));
        $this->id = $args['id'];
